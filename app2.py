...
# Navigation
nav_options = ["Home", "Biometric ID", "Access Logs", "About"]
...
def fetch_and_decrypt(cid):
    ...
    pil = decrypt_image_pixels(encrypted_bytes, shape, dtype, iv, key_seq)
    arr = np.array(pil)
        ...
        with col1:
            ...
            <div class="feature-card">
                ...
                <p style="color: #86868b; line-height: 1.6;">
                    Military-grade encrypted biometric templates distributed across IPFS nodes
                </p>
            </div>
            """, unsafe_allow_html=True)
        with col2:
    ...
    with st.sidebar:
        ...
        if uploaded_image:
            try:
                ...
                encrypted_bytes, shape, dtype, iv, key_seq = encrypt_image_pixels(img)
